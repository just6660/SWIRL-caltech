...
jnp.savez(save_folder + f'{K}_{seed}_NM_caltech_compressed_net2.npz',
          new_logpi0=lp2, new_log_Ps=lP2, new_Rs=R2,
          new_R_state=Rs2.params, train_LL_list=LL2_train, test_LL_list=LL2_test)
print(f"Saved {K}_{seed}_NM_caltech_compressed_net2.npz\n")
...
jnp.savez(save_folder + f'{K}_{seed}_NM_caltech_compressed_net1.npz',
...
print(f"Saved {K}_{seed}_NM_caltech_compressed_net1.npz")
