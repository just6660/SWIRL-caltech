...
# ── load results ──────────────────────────────────────────────────────────────
net1 = np.load(save_folder + f'{K}_{seed}_NM_caltech_compressed_net1.npz', allow_pickle=True)
net2 = np.load(save_folder + f'{K}_{seed}_NM_caltech_compressed_net2.npz', allow_pickle=True)
...
def _load_multi_K(model_tag, seed_):
    pattern = save_folder + f'*_{seed_}_NM_caltech_compressed_{model_tag}.npz'
